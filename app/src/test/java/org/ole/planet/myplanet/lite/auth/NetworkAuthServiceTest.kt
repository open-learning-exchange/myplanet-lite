...
class NetworkAuthServiceTest {
    ...
    @Test
    fun `login success without cookie clears token`() =
        runTest {
    ...
    @Test
    fun `login success with empty cookie clears token`() =
        runTest {
            tokenStorage.saveToken("old_token")
            mockWebServer.enqueue(
                MockResponse()
    ...
    @Test
    fun `login success with blank cookie clears token`() =
        runTest {
            tokenStorage.saveToken("old_token")
            mockWebServer.enqueue(
                MockResponse()
    ...
    @Test
    fun `login success with null body returns invalid response error`() =
        runTest {
            mockWebServer.enqueue(
                MockResponse()
                    .setResponseCode(204),
    ...
    @Test
    fun `login success with ok false returns server rejected error`() =
        runTest {
            mockWebServer.enqueue(
                MockResponse()
                    .setResponseCode(200)
    ...
    @Test
    fun `login invalid credentials returns error`() =
        runTest {
            mockWebServer.enqueue(
                MockResponse()
                    .setResponseCode(401)
    ...
    @Test
    fun `login network failure returns error`() =
        runTest {
            mockWebServer.enqueue(
    ...
    @Test
    fun `login returns raw body when error JSON is malformed`() =
        runTest {
    ...
    @Test
    fun `login error with empty error body returns default error message`() =
        runTest {
            mockWebServer.enqueue(
                MockResponse()
                    .setResponseCode(500)
    ...
    @Test
    fun `login returns raw body when error JSON has unknown keys`() =
        runTest {
    ...
    @Test
    fun `login error parses message key`() =
        runTest {
            mockWebServer.enqueue(
                MockResponse()
                    .setResponseCode(400)
    ...
    @Test
    fun `login error parses detail key`() =
        runTest {
            mockWebServer.enqueue(
                MockResponse()
                    .setResponseCode(400)
    ...
    @Test
    fun `login http exception returns error`() =
        runTest {
    ...
    @Test
    fun `login http exception 401 returns error`() =
        runTest {
            val mockApi = mock<AuthApi>()
            val errorResponse =
                Response.error<LoginResponse>(
    ...
    @Test
    fun login_HttpException401_returnsInvalidCredentials() =
        runTest {
            val mockApi = mock<AuthApi>()
            val errorResponse =
                Response.error<LoginResponse>(
    ...
    @Test
    fun `login http exception 404 returns error`() =
        runTest {
            val mockApi = mock<AuthApi>()
            val errorResponse =
                Response.error<LoginResponse>(
    ...
    @Test
    fun `login io exception returns network error`() =
        runTest {
            val mockApi = mock<AuthApi>()
    ...
    @Test
    fun `login io exception with real network client interceptor returns network error`() =
        runTest {
    ...
    @Test
    fun `login io exception localized message is used`() =
        runTest {
            val mockApi = mock<AuthApi>()
            val ioException =
                object : java.io.IOException("Regular message") {
                    override fun getLocalizedMessage(): String = "Localized IO error"
                }
            whenever(mockApi.login(any())).thenAnswer { throw ioException }
    ...
    @Test
    fun `login io exception without message returns network error fallback`() =
        runTest {
            val mockApi = mock<AuthApi>()
    ...
    fun `login cancellation exception is rethrown`() =
        runTest {
            val mockApi = mock<AuthApi>()
    ...
    @Test
    fun `login unexpected exception returns generic error`() =
        runTest {
            val mockApi = mock<AuthApi>()
    ...
    @Test
    fun `logout invokes clearToken on mocked token storage`() =
        runTest {
            val mockApi = mock<AuthApi>()
    ...
    @Test
    fun `getStoredToken returns token`() =
        runTest {
    ...
    @Test
    fun `getStoredToken returns null when empty`() =
        runTest {
    ...
    @Test
    fun `getStoredToken invokes getToken on mocked TokenStorage`() =
        runTest {
            val mockTokenStorage = mock<TokenStorage>()
    ...
    @Test
    fun `authenticate io exception returns error`() =
        runTest {
            val mockApi = mock<AuthApi>()
            val ioException = java.io.IOException("Custom IO error")
    ...
    @Test
    fun `authenticate socket timeout exception returns error`() =
        runTest {
            val mockApi = mock<AuthApi>()
    ...
    @Test
    fun `authenticate http exception returns network error`() =
        runTest {
            val mockApi = mock<AuthApi>()
    ...
    @Test
    fun `authenticate generic exception returns error`() =
        runTest {
            val mockApi = mock<AuthApi>()
            val unexpectedException = RuntimeException("Something bad happened")
    ...
    @Test
    fun `authenticate unsuccessful response returns error`() =
        runTest {
            val mockApi = mock<AuthApi>()
    ...
    @Test
    fun `login successful with null body returns error`() =
        runTest {
            val mockApi = mock<AuthApi>()
    ...
    @Test
    fun `login dispatcher exception returns generic error`() =
        runTest {
            val mockApi = mock<AuthApi>()
            val failingDispatcher =
                object : kotlinx.coroutines.CoroutineDispatcher() {
                    override fun dispatch(
                        ...
                        block: Runnable,
                    ): Unit = throw RuntimeException("Dispatcher failure")
                }
