...
internal fun resolveSubmissionApp(existingSubmission: DashboardSurveySubmissionsRepository.SubmissionLookup?): String? =
    if (existingSubmission == null) PlanetAppIdentity.APP_ID else existingSubmission.app
